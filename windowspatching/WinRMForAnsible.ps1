...
# Enable PS remoting for remote powershell command execution and disable the Firewall

NetSh Advfirewall set allprofiles state off
Enable-PSRemoting -Force

#Sample command to get process list
Get-Process | Out-File 'c:\getprocess.txt' -Force
